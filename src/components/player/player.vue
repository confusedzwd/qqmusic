    ...
    export default {
        ...
        watch: {
            currentSong(newSong, oldSong) {
                ...
                axios.post("http://zwd.pub:1110/api/getSongDetailData", JSON.stringify(data)).then((data) => {
            ...
            songData() {
                ...
                axios.post("http://zwd.pub:1110/api/getLyric", JSON.stringify(data)).then((data) => {
